...
4. The VNets that the managed instances are part of need to be connected through a [VPN Gateway](../vpn-gateway/vpn-gateway-about-vpngateways.md) or Express Route. Global VNet Peering is not supported. When two VNETs are connected through on-premise network, please ensure there is no firewall blocking port 5022 and 11000-12000.
